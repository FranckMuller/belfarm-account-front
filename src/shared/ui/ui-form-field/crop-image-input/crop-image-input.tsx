...
import { CroppedImagesPreview } from './components/cropped-images-preview'
import { ImageCropper } from './components/image-cropper'
import { useMultipleImageCropInput } from './use-image-crop-input'
...
export const CropImageInput = <T extends FieldValues>({
  name,
  control,
  maxCount,
  files,
